...
TEST(uBasicNGSGENCHR_countSitesWithProperty, SOMECOUNTED){
      StandardChroms testChroms;
       auto functOp = [](const uBasicNGS & item) mutable {  return (item.getLength()>99);
       StandardChroms testChroms;
       };
 ...
 TEST(uBasicNGSGENCHR_countSitesWithProperty, ALLCOUNTED){
       StandardChroms testChroms;
       auto functOp = [](const uBasicNGS & item){  return (item.getLength()>2);
       };
 ...
 TEST(uBasicNGSGENCHR_countSitesWithProperty, NONECOUNTED){
       StandardChroms testChroms;
       auto functOp = [](const uBasicNGS & item){  return (item.getLength()>200000);
       };
...
{
       StandardChroms testChroms;
       auto minItr=  testChroms.manyChr.minSite(uBasicNGSChrom::compareLength);
...
{
       StandardChroms testChroms;
       auto minItr=  testChroms.manyChr.maxSite(uBasicNGSChrom::compareLength);
...
TEST(uBasicNGSGENCHR_minAndMaxSites, VALIDCOMPILE){
       StandardChroms testChroms;
        testChroms.manyChr.minAndMaxSites(uBasicNGSChrom::compareLength);
 }
